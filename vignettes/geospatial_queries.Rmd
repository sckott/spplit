...
[http://arthur-e.github.io/Wicket/sandbox-gmaps3.html](http://arthur-e.github.io/Wicket/sandbox-gmaps3.html).

You can get WKT from within R using the `wellknown` package.
([https://cran.rstudio.com/web/packages/wellknown/](https://cran.rstudio.com/web/packages/wellknown/)).
With `wellknown` you can get WKT from R objects, and convert GeoJSON to WKT as well. For example:
...
`SpatialPolygons` and `SpatialPolygonsDataFrame` are two classes of object defined in the
package `sp` ([https://cran.rstudio.com/web/packages/sp](https://cran.rstudio.com/web/packages/sp)).
...
#> Geometry [<geo1> (10)] 
#> Source: local data frame [10 x 73]
#> 
#>                         name longitude latitude  prov         issues
#>                        <chr>     <dbl>    <dbl> <chr>          <chr>
#> 1     Fritillaria pluriflora -122.4809 38.80458  gbif cdround,gass84
#> 2       Vaccinium cespitosum -122.4362 37.69014  gbif               
#> 3     Castilleja rubicundula -122.4261 38.86579  gbif cdround,gass84
#> 4         Allium falcifolium -122.3765 38.80701  gbif cdround,gass84
#> 5         Angelica tomentosa -122.6142 38.04393  gbif cdround,gass84
#> 6          Allium amplectens -122.4262 38.86566  gbif cdround,gass84
#> 7            Sidalcea keckii -122.4261 38.86566  gbif cdround,gass84
#> 8      Orobanche fasciculata -120.9542 38.95750  gbif cdround,gass84
#> 9  Hesperolinon californicum -122.7088 38.18759  gbif cdround,gass84
#> 10    Collinsia heterophylla -122.3375 38.76694  gbif cdround,gass84
...
#>   genericName <chr>, specificEpithet <chr>, taxonRank <chr>, elevation
#>   <dbl>, continent <chr>, stateProvince <chr>, year <int>, month <int>,
#>   day <int>, eventDate <date>, lastInterpreted <chr>, identifiers <chr>,
#>   facts <chr>, relations <chr>, geodeticDatum <chr>, class <chr>,
#>   countryCode <chr>, country <chr>, recordNumber <chr>, identifier <chr>,
#>   habitat <chr>, verbatimEventDate <chr>, nomenclaturalCode <chr>,
#>   higherGeography <chr>, institutionID <chr>, county <chr>, locality
#>   <chr>, language <chr>, gbifID <chr>, collectionCode <chr>, occurrenceID
#>   <chr>, type <chr>, recordedBy <chr>, catalogNumber <chr>,
#>   otherCatalogNumbers <chr>, institutionCode <chr>, startDayOfYear <chr>,
#>   verbatimElevation <chr>, identifiedBy <chr>, higherClassification <chr>,
#>   occurrenceRemarks <chr>, infraspecificEpithet <chr>, verbatimTaxonRank
#>   <chr>, elevationAccuracy <dbl>.
```
